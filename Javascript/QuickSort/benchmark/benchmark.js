...
Benchmark = {
    ...
    initialize : function(options) {
        ...
        || typeof options['stdout']['error'] == 'undefined') {
            throw new Error('StdoutError', 'STDOUT object must implement log, warn and error methods');
        }
        ...
        switch( typeof args[0] ) {
            ...
            case "string":
                ...
                if ( typeof args[1] == "number" ) {
                    ...
                    if ( typeof args[2] == "function") {
                        ...
                        throw new Error( 'ArgumentError', "Third argument must be a function" );
                        return;
                    }
            ...
            case "number":
                ...
                if (typeof args[1] == "function") {
                    ...
                    throw new Error( 'ArgumentError', "Second argument must be a function" );
                    return;
                }
                break;
            ...
            default:
                this.type = "failure";
                this.repeat = 1;
                throw new Error( 'ArgumentError', "Invalid argument type." );
                return;
                break;
        }
    ...
    report : function() {
        ...
        for ( r in this.results ) {
            ...
            var time = "(   " + parseFloat(this.results[r]).toFixed(4) + ")";
        ...
        this.STDOUT.innerHTML = this.output;
    },
    ...
    group_total_line : function() {
        this.output += "-".repeat( this.get_padding() ) + " total: " + parseFloat(this.total).toFixed(4) + "";
    },
